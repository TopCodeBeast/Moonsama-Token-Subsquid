module.exports = class Init1658568000729 {
  name = 'Init1658568000729'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "contract" ("id" character varying NOT NULL, "name" text, "symbol" text, "total_supply" numeric, "contract_uri" text, "contract_uri_updated" numeric, "address" text, "decimals" integer, CONSTRAINT "PK_17c3a89f58a2997276084e706e8" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "numeric_id" numeric NOT NULL, "uri" text, "owner_id" character varying, "meta_id" character varying, "contract_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
